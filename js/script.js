...
document.addEventListener('click', e => {
    if (e.target === btnSi) {
        Swal.fire({
            title: 'Vamos por mas fechas especiales en las que podamos compartir juntos ❤️',
            ...
            if (result.isConfirmed) {
                let url = "https://api.whatsapp.com/send?phone=522214336721&text=" + "Te quiero mucho mi amor y aunque no siempre te lo diga tu ya lo escribes por mi... Feliz 14 de febrero 🥰" + "%0A";
